...
public:
	...
	int EMove(int& nowMoveOrder, int& nowPatternOrder, TimeCount& timeCnt, CollisionManager* colmanager, TemporaryCollisionManager& tempmanager, GameObject& gameObject);
