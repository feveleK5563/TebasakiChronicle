...
{
	CST::LoadAndGetTexture("Life針", "data/image/ScreenUI/Life針.png");
	lifeNeedle = new GUIObject("Life針", K_Math::Vector3(31, 155, 0), K_Math::Box2D(0, 0, 67, 120));
